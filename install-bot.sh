...
ExecStart=$APP_DIR/.venv/bin/python $APP_DIR/external_bot_v10.py
Restart=always
RestartSec=3
User=root
UMask=0077
...
echo
echo "✅ ربات خارجی v10 نصب و اتصال Telegram تست شد."
echo "✅ اتصال سایت‌ها دارای keep-alive، retry و backoff خودکار است."
echo "✅ داشبورد، بکاپ، مشتری، سفارش، رسید و ایمیل همگانی فعال است."
