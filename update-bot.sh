...
ExecStart=$APP_DIR/.venv/bin/python $APP_DIR/external_bot_plus.py
Restart=always
RestartSec=3
User=root
UMask=0077
...
echo "✅ ربات خارجی آپدیت شد."
echo "✅ دیتابیس مدیرها و سایت‌های متصل در /var/lib/sanashop-bot حفظ شده است."
