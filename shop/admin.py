...
from .models import Category, EmailVerificationToken, Order, OrderItem, OrderStatusEvent, PaymentReceipt, Product, ProductImage, SiteSetting
...
class ProductAdmin(admin.ModelAdmin):
    list_display = ("sku", "name", "category", "price", "stock", "is_active", "is_featured", "updated_at")
