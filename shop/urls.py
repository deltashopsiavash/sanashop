...
from . import account_views, checkout_views_v17, views
...
urlpatterns = [
    ...
    path("checkout/", checkout_views_v17.checkout, name="checkout"),
    path("payment/card/<str:code>/", checkout_views_v17.card_payment, name="card_payment"),
    path("order/<str:code>/", views.order_status, name="order_status"),
    path("payment/zarinpal/callback/", checkout_views_v17.zarinpal_callback, name="zarinpal_callback"),
